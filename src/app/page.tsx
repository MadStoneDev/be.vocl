...
export default function Home() {
  ...
  const handleReblog = (type: "instant" | "with-comment" | "schedule" | "queue") => {
    ...
    // - instant: Immediately reblog without comment
    // - with-comment: Open dialog to add comment, then reblog
    // - schedule: Open date picker to schedule the reblog
    // - queue: Add to user's queue for automatic posting
