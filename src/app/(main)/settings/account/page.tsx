  ...
  return (
    <div className="py-6">
      ...
      <div className="mb-8 border-b border-vocl-border pb-5">
        ...
        <h1 className="type-display font-display text-ink">Account &amp; Data</h1>
      ...
      <section className="mb-10">
        <h2 className="type-heading font-display text-ink mb-3 flex items-center gap-2">
          <IconDownload size={20} className="text-vocl-primary" />
          Export your data
        </h2>
        <div className="p-4 border border-rule space-y-3">
          ...
          {exportStatus.status === "completed" && exportStatus.fileUrl ? (
            <div className="flex items-center gap-2">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2  bg-accent text-white text-sm font-medium hover:opacity-[0.88] transition-colors"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2  bg-accent text-white text-sm font-medium hover:opacity-[0.88] disabled:opacity-50 transition-colors"
            >
              {requestingExport ? (
                <IconLoader2 size={14} className="animate-spin" />
              ) : (
      ...
      <section className="mb-10">
        ...
        <div className="p-4  bg-rose-500/5 border border-rose-500/20 space-y-4">
          <div>
          ...
          {deleteStep === "idle" && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2  bg-rose-500/20 text-rose-400 text-sm font-medium hover:bg-rose-500/30"
            >
            ...
            <div className="space-y-3 pt-3 border-t border-rose-500/20">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-2  bg-rose-500/30 text-rose-300 text-sm font-medium"
                >
                  Continue
                </button>
                <button
                  onClick={() => setDeleteStep("idle")}
                  className="px-3 py-2  bg-vocl-hover-strong text-foreground text-sm"
                >
                  Cancel
                </button>
              </div>
          ...
          {deleteStep === "type-username" && profile && (
            <div className="space-y-3 pt-3 border-t border-rose-500/20">
              ...
              <input
                ...
                className="w-full px-3 py-2  bg-background/50 border border-rose-500/30 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
              />
              <div className="flex gap-2">
                <button
                  onClick={() => setDeleteStep("final")}
                  disabled={deleteUsernameInput !== profile.username}
                  className="px-3 py-2  bg-rose-500/30 text-rose-300 text-sm font-medium disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Continue
                </button>
                <button
            ...
            <div className="space-y-3 pt-3 border-t border-rose-500/20">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={deleting}
                  className="inline-flex items-center gap-1.5 px-3 py-2  bg-rose-500 text-white text-sm font-medium hover:bg-rose-600 disabled:opacity-50"
                >
                  {deleting ? (
                    <IconLoader2 size={14} className="animate-spin" />
                  ) : (
