      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 rounded-sm bg-vocl-surface-dark border border-vocl-border text-foreground placeholder:text-foreground/40 focus:outline-none focus:ring-2 focus:ring-vocl-primary focus:border-transparent text-sm"
            required
            minLength={2}
            maxLength={60}
          />
        ...
        <div>
          ...
          <div className="flex items-stretch rounded-sm bg-vocl-surface-dark border border-vocl-border focus-within:ring-2 focus-within:ring-vocl-primary focus-within:border-transparent overflow-hidden">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            maxLength={500}
            className="w-full px-3 py-2.5 rounded-sm bg-vocl-surface-dark border border-vocl-border text-foreground placeholder:text-foreground/40 focus:outline-none focus:ring-2 focus:ring-vocl-primary focus:border-transparent text-sm resize-none"
          />
        </div>
