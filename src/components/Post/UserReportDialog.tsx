...
export function UserReportDialog({
  ...
  return (
    <Portal>
      ...
      {/* Dialog */}
      <div className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md bg-vocl-surface-dark rounded-sm z-50 flex flex-col max-h-[90vh] overflow-hidden">
        {/* Header */}
