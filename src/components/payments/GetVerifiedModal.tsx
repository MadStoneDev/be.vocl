          ...
          <>
            ...
            <div className="p-4 border-t border-vocl-border">
              <button
                ...
                disabled={isProcessing}
                className="w-full py-3 rounded-sm bg-vocl-primary text-white type-body font-semibold hover:bg-vocl-primary-hover transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isProcessing ? (
                  <>
