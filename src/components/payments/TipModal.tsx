          ...
          <>
            ...
            <div className="px-4 pb-4">
              ...
              <textarea
                ...
                rows={2}
                disabled={isProcessing}
                className="w-full px-3 py-2 rounded-sm bg-background border border-vocl-border text-foreground type-body placeholder:text-foreground/40 focus:outline-none focus:ring-2 focus:ring-vocl-primary resize-none disabled:opacity-50"
              />
            </div>
            ...
            <div className="p-4 border-t border-vocl-border">
              <button
                ...
                className="w-full py-3 rounded-sm bg-gradient-to-r from-yellow-500 to-orange-500 text-white type-body font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isProcessing ? (
                  <>
