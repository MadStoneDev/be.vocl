...
export function AskModal({
  ...
  return (
    <Portal>
      ...
      {/* Modal */}
      <div className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md bg-vocl-surface-dark rounded-none z-50 flex flex-col max-h-[90vh]">
        {/* Header */}
            ...
            <div className="space-y-4">
              <div>
                <textarea
                  ...
                  rows={4}
                  maxLength={500}
                  className="w-full py-3 px-4 rounded-none bg-background/50 border border-vocl-border text-foreground placeholder:text-foreground/40 focus:outline-none focus:border-vocl-primary resize-none"
                />
              ...
              {/* Anonymous toggle */}
              {allowsAnonymous && (
                <label className="flex items-center gap-3 p-3 rounded-none bg-background/30 cursor-pointer">
                  <div
          ...
          <div className="p-4 border-t border-vocl-border">
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 rounded-none bg-vocl-primary text-white font-medium hover:bg-vocl-primary-hover transition-colors disabled:opacity-50"
              >
                {isSubmitting ? (
                  <>
