      ...
      <div className="relative w-full max-w-md mx-4 bg-background border border-vocl-border rounded-sm shadow-2xl">
        ...
        {!submitted && (
          <div className="flex gap-3 p-4 border-t border-vocl-border">
            <button
              onClick={handleClose}
              className="flex-1 py-2.5 px-4 rounded-sm border border-vocl-border text-foreground/70 hover:text-foreground hover:bg-vocl-hover transition-colors type-meta font-semibold"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 py-2.5 px-4 rounded-sm bg-vocl-like text-white type-meta font-semibold hover:bg-vocl-like/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
